...
// static casadi_int casadi_s7[3 + n_states * n_stp];
// casadi_s7[0] = n_states * n_stp;
// casadi_s7[1] = n_states * n_stp;
// for (int i = 0; i < n_states * n_stp; i++) {
//   casadi_s7[2 + i] = 0;
// }
  
// static const casadi_int casadi_s8[3 + n_controls * n_stp]; 
// casadi_s8[0] = n_states * n_stp;
// casadi_s8[1] = n_controls * n_stp;
// for (int i = 0; i < n_controls * n_stp; i++) {
//   casadi_s8[2 + i] = 0;
// }

// static const casadi_int casadi_s9[3 + n_stp];
// casadi_s9[0] = n_states * n_stp;
// casadi_s9[1] = n_stp;
