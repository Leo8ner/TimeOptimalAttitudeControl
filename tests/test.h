...
inline constexpr sunrealtype SENSITIVITY_ATOL = 1e-1;
inline constexpr sunrealtype SENSITIVITY_RTOL = 1e-1;
...
public:
    ...
    int computeFullSensitivityFiniteDifference(
    ...
    int compareAnalyticalVsFiniteDifference(
