...
actual = ca.Sparsity.from_file("../build/debug_fatrop_actual.mtx")

A = ca.Sparsity.from_file("../build/debug_fatrop_A.mtx")
B = ca.Sparsity.from_file("../build/debug_fatrop_B.mtx")
C = ca.Sparsity.from_file("../build/debug_fatrop_C.mtx")
D = ca.Sparsity.from_file("../build/debug_fatrop_D.mtx")
I = ca.Sparsity.from_file("../build/debug_fatrop_I.mtx")
errors = ca.Sparsity.from_file("../build/debug_fatrop_errors.mtx").row()
